...
public class DiccionarioDeMonedas {
    HashMap<String, String> currencyMap = new HashMap<>();

    public DiccionarioDeMonedas() {
        ...
        currencyMap.put("BAM", "Bosnia and Herzegovina Mark");
        ...
        currencyMap.put("TVD", "Tuvaluan Dollar");
        ...
        currencyMap.put("UZS", "Uzbekistani So'm");
        currencyMap.put("VES", "Venezuelan Bolívar Soberano");
        currencyMap.put("VND", "Vietnamese Đồng");
        currencyMap.put("VUV", "Vanuatu Vatu");
        currencyMap.put("WST", "Samoan Tālā");
